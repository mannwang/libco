...
PROGS = colib example_poll example_echosvr example_echocli example_thread  example_cond example_specific example_copystack example_closure example_co example_coss
...
example_closure:example_closure.o
	$(BUILDEXE)
example_co:example_co.o
	$(BUILDEXE)
example_coss:example_coss.o
	$(BUILDEXE)
